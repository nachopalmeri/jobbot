    ...
    if plan == "premium":
        ...
        if web_user:
            ...
            await update.message.reply_text(
                ...
                f"• 120 búsquedas por día\n"
                f"• 20 análisis IA de CV por mes\n"
                f"• 10 mock interviews por mes\n"
                f"• CV Tailoring y cover letters premium\n"
                f"• Job tracker completo y workflow de CV\n\n"
...
async def precios(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "🗓️ También podés elegir <b>anual</b> para ahorrar 2 meses.\n"
        "🪙 Y si preferís pagar por uso, tenés <b>créditos</b> y unlock de CV Suite.\n\n"
