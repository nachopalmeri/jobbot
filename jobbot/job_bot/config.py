...
TELEGRAM_BOT_USERNAME = os.getenv("TELEGRAM_BOT_USERNAME", "jobs912bot")
...
LANDING_URL = os.getenv(
    "LANDING_URL",
    "https://jobbot.ar" if APP_ENV == "production" else "http://127.0.0.1:3000",
)

# ============================================================
# BACKUP SYSTEM - Configuración del sistema de backup
# ============================================================
BACKUP_DIR = os.getenv("BACKUP_DIR", "backups")
BACKUP_RETENTION_DAYS = int(os.getenv("BACKUP_RETENTION_DAYS", "30"))
BACKUP_SCHEDULE = os.getenv("BACKUP_SCHEDULE", "02:00")  # HH:MM formato 24h
BACKUP_COMPRESS = os.getenv("BACKUP_COMPRESS", "true").lower() == "true"
BACKUP_ADMIN_USER_ID = int(os.getenv("BACKUP_ADMIN_USER_ID", "0"))  # Telegram ID del admin para notificaciones
